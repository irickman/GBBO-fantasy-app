        ...
        <div className="bg-white rounded-lg shadow-lg p-8">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
            <div className="bg-amber-50 p-6 rounded-lg border border-amber-200">
              ...
              <p className="text-amber-600 mb-3">View current standings</p>
              <Link
            ...
            <div className="bg-amber-50 p-6 rounded-lg border border-amber-200">
              ...
              <p className="text-amber-600 mb-3">Add weekly scores</p>
              <Link
                className="inline-block bg-amber-600 hover:bg-amber-700 text-white font-bold py-2 px-4 rounded-md transition-colors"
                href="/admin/scoring"
              >
            ...
            <div className="bg-amber-50 p-6 rounded-lg border border-amber-200">
              ...
              <p className="text-amber-600 mb-3">Create players & assign contestants</p>
              <Link
                className="inline-block bg-amber-600 hover:bg-amber-700 text-white font-bold py-2 px-4 rounded-md transition-colors"
                href="/admin/teams"
              >
